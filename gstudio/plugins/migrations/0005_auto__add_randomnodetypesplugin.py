...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RandomNodetypesPlugin'
        db.create_table('cmsplugin_randomnodetypesplugin', (
        ...
        db.send_create_signal('plugins', ['RandomNodetypesPlugin'])

    def backwards(self, orm):

        # Deleting model 'RandomNodetypesPlugin'
        db.delete_table('cmsplugin_randomnodetypesplugin')
    ...
    models = {
        ...
        'plugins.randomnodetypesplugin': {
            'Meta': {'object_name': 'RandomNodetypesPlugin', 'db_table': "'cmsplugin_randomnodetypesplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'number_of_nodetypes': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'template_to_render': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'})
        },
        ...
        'gstudio.nodetype': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'Nodetype'},
