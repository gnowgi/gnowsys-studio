...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LatestNodetypesPlugin.template_to_render'
        db.add_column('cmsplugin_latestnodetypesplugin', 'template_to_render', self.gf('django.db.models.fields.CharField')(default='gstudio/cms/nodetype_list.html', max_length=250, blank=True), keep_default=False)

        # Adding field 'SelectedNodetypesPlugin.template_to_render'
        db.add_column('cmsplugin_selectednodetypesplugin', 'template_to_render', self.gf('django.db.models.fields.CharField')(default='gstudio/cms/nodetype_list.html', max_length=250, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'LatestNodetypesPlugin.template_to_render'
        db.delete_column('cmsplugin_latestnodetypesplugin', 'template_to_render')

        # Deleting field 'SelectedNodetypesPlugin.template_to_render'
        db.delete_column('cmsplugin_selectednodetypesplugin', 'template_to_render')
