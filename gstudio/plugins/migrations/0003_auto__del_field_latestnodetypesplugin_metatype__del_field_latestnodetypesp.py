...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LatestNodetypesPlugin.author'
        db.delete_column('cmsplugin_latestnodetypesplugin', 'author_id')

        # Adding M2M table for field tags on 'LatestNodetypesPlugin'
        db.create_table('plugins_latestnodetypesplugin_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('latestnodetypesplugin', models.ForeignKey(orm['plugins.latestnodetypesplugin'], null=False)),
            ('tag', models.ForeignKey(orm['tagging.tag'], null=False))
        ))
        db.create_unique('plugins_latestnodetypesplugin_tags', ['latestnodetypesplugin_id', 'tag_id'])

        # Adding M2M table for field metatypes on 'LatestNodetypesPlugin'
        db.create_table('plugins_latestnodetypesplugin_metatypes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('latestnodetypesplugin', models.ForeignKey(orm['plugins.latestnodetypesplugin'], null=False)),
            ('metatype', models.ForeignKey(orm['gstudio.metatype'], null=False))
        ))
        db.create_unique('plugins_latestnodetypesplugin_metatypes', ['latestnodetypesplugin_id', 'metatype_id'])

        # Adding M2M table for field authors on 'LatestNodetypesPlugin'
        db.create_table('plugins_latestnodetypesplugin_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('latestnodetypesplugin', models.ForeignKey(orm['plugins.latestnodetypesplugin'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('plugins_latestnodetypesplugin_authors', ['latestnodetypesplugin_id', 'user_id'])

    def backwards(self, orm):

        # Adding field 'LatestNodetypesPlugin.metatype'
        db.add_column('cmsplugin_latestnodetypesplugin', 'metatype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gstudio.Metatype'], null=True, blank=True), keep_default=False)

        # Adding field 'LatestNodetypesPlugin.author'
        db.add_column('cmsplugin_latestnodetypesplugin', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field tags on 'LatestNodetypesPlugin'
        db.delete_table('plugins_latestnodetypesplugin_tags')

        # Removing M2M table for field metatypes on 'LatestNodetypesPlugin'
        db.delete_table('plugins_latestnodetypesplugin_metatypes')

        # Removing M2M table for field authors on 'LatestNodetypesPlugin'
        db.delete_table('plugins_latestnodetypesplugin_authors')
