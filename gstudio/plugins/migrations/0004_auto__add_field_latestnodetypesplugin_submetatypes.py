...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LatestNodetypesPlugin.submetatypes'
        db.add_column('cmsplugin_latestnodetypesplugin', 'submetatypes', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'LatestNodetypesPlugin.submetatypes'
        db.delete_column('cmsplugin_latestnodetypesplugin', 'submetatypes')
